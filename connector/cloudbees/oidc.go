// Package cloudbees implements logging in through the CloudBees SSO provider
// It's based on the oidc connector, but adds a custom mapping from claims to UserID
package cloudbees
...
func (c *oidcConnector) HandleCallback(s connector.Scopes, r *http.Request) (identity connector.Identity, err error) {
	...
	var claims struct {
		...
		} `json:"https://cloudbees.com/user_metadata"`
	}
